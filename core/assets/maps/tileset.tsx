...
<tileset name="tileset" tilewidth="32" tileheight="32" tilecount="100" columns="10">
 <image source="tileset.png" width="320" height="320"/>
 <terraintypes>
  <terrain name="Water" tile="40"/>
  <terrain name="Grass" tile="41"/>
 </terraintypes>
